...
# heatmap on row scaling
pheatmap(df_num_scale,scale = "row",main = "Differentially expressed genes across stimulations in THA")
```
...
# heatmap on row scaling
pheatmap(df_num_scale,scale = "row",main = "Differentially expressed genes across stimulations in CC")
```
