...
sorted <- df_num[, order(metadata_filt_ordered$Stimulation, decreasing = T)]
as.factor(metadata_filt_ordered$Stimulation)
library(dplyr)
metadata_filt_ordered <- metadata_filt_ordered[colnames(sorted),]
metadata_filt_ordered$Stimulation <- as.factor(metadata_filt_ordered$Stimulation)

ann <- data.frame(metadata_filt_ordered$Stimulation)
