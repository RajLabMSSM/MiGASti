...
#1201 genes (row scaling data)

```{r heatmap_GFM_cor3, echo=TRUE, message=FALSE}
pheatmap(df_num, scale = "row", main = "Differentially expressed genes across stimulations in GFM")
```
