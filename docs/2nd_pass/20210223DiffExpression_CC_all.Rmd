...
metadata_cultured_subset <- metadata_cultured[metadata_cultured$Stimulation != "ununstim",]
#check numbers
#dim(metadata_cultured)
#check numbers per stimulation
#table(metadata_filt$Stimulation)
#select only CC samples in metadata
metadata_CC = metadata_cultured_subset[metadata_cultured_subset$Region=="CC",]
