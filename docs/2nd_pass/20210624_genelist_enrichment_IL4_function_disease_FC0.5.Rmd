...
# IL4 UP FDR 5% logFC > 0.5 

```{r vul_IL4, echo = TRUE}
load("~/Documents/MiGASti/docs/2nd_pass/res_IL4_name.Rdata")
res_IL4 <- res_IL4_name

sign <- subset(res_IL4, adj.P.Val < 0.05)
IL4_UP <- subset(sign, logFC > 0.5)
...
# IL4 DOWN FDR 5% logFC < -0.5 

```{r vul_IL42, echo = TRUE}
load("~/Documents/MiGASti/docs/2nd_pass/res_IL4_name.Rdata")
res_IL4 <- res_IL4_name

sign <- subset(res_IL4, adj.P.Val < 0.05)
IL4_DOWN <- subset(sign, logFC < -0.5)
