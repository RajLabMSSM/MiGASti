...
# ATP UP FDR 5% logFC > 0.5 

```{r vul_ATP, echo = TRUE}
load("~/Documents/MiGASti/docs/2nd_pass/res_ATP_name.Rdata")
res_ATP <- res_ATP_name

sign <- subset(res_ATP, adj.P.Val < 0.05)
ATP_UP <- subset(sign, logFC > 0.5)
...
# ATP DOWN FDR 5% logFC < -0.5 

```{r vul_ATP2, echo = TRUE}
load("~/Documents/MiGASti/docs/2nd_pass/res_ATP_name.Rdata")
res_ATP <- res_ATP_name

sign <- subset(res_ATP, adj.P.Val < 0.05)
ATP_DOWN <- subset(sign, logFC < -0.5)
