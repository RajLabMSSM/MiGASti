---
title: "Microglia_monocyte_comparisons_ranking_400"
author: "Gijsje"
date: "2/24/2021"
output: 
...
merged_migasti_unstim[1:400, ]
migasti_unstim <- merged_migasti_unstim[1:400, ]
```
...
merged_migasti_ununstim[1:400, ]
migasti_ununstim <- merged_migasti_ununstim[1:400, ]
```
...
merged_monocytes[1:400, ]
cultured_monocytes <- merged_monocytes[1:400, ]
```
...
data.table(merged_macrophages[1:400, ])
macrophages <- merged_macrophages[1:400, ]
...
data.table(merged_microglia_EV_Gosselin[1:400, ])
microglia_EV_Gosselin <- merged_microglia_EV_Gosselin[1:400, ]
...
data.table(merged_microglia_IV_Gosselin[1:400, ])
microglia_IV_Gosselin <- merged_microglia_IV_Gosselin[1:400, ]
...
data.table(merged_microglia_mono_Gosselin[, ])
monocytes_Gosselin <- merged_microglia_mono_Gosselin[1:400, ]
...
overlap_microglia_mono_Gosselin <- merge(migasti_unstim, monocytes_Gosselin, by = "symbol")
...
percentage <- rbind(percentage_migasti_miga, percentage_migasti, percentage_migasti_cultured_monocytes, percentage_migasti_macrophages, percentage_migasti_EV_Gosselin, percentage_migasti_IV_Gosselin, percentage_migasti_mono_Gosselin) 
