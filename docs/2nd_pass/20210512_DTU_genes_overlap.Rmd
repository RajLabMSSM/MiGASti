...
res_name_LPS2 <- subset(res_name_LPS2, adj.P.Val < 0.05)
res_name_IFNy2 <- subset(res_name_IFNy2, adj.P.Val < 0.05)
res_name_R8482 <- subset(res_name_R8482, adj.P.Val < 0.05)
res_name_IL42 <- subset(res_name_IL42, adj.P.Val < 0.05)
res_name_TNFa2 <- subset(res_name_TNFa2, adj.P.Val < 0.05)
res_name_ATP2 <- subset(res_name_ATP2, adj.P.Val < 0.05)
```
...
### TNFa Overlap DTU transcripts and genes 
#How many unique genes and significance?

```{r TNFa overlap, echo = TRUE}
overlap_TNFa <- merge(TNFa_S, res_name_TNFa2, by = "symbol")
unique(overlap_TNFa$symbol)
set1 <- TNFa_S
set2 <- res_name_TNFa2
