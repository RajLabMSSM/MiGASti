...
### Overlap with significant microglia LPS genes FDR 5% log FC > 1

```{r overlap_LPS_LF_sets2, echo = TRUE}
sign_microglia_LPS <- subset(res_name_LPS2, adj.P.Val < 0.05)
sign_microglia_LPS_LF <- subset(sign_microglia_LPS, logFC > 1)
sign_monocytes_LPS <- subset(res_LPS_monocytes, adj.P.Val < 0.05)
sign_monocytes_LPS_LF <- subset(sign_monocytes_LPS, logFC > 1)
...
### Overlap with significant microglia IFNy genes FDR 5% log FC > 1

```{r overlap_IFNy_LF, echo = TRUE}
sign_microglia_IFNy <- subset(res_name_IFNy2, adj.P.Val < 0.05)
sign_microglia_IFNy_LF <- subset(sign_microglia_IFNy, logFC > 1)
sign_monocytes_IFNy <- subset(res_IFNy_monocytes, adj.P.Val < 0.05)
sign_monocytes_IFNy_LF <- subset(sign_monocytes_IFNy, logFC > 1)
...
### Overlap with significant microglia LPS genes FDR 5% log FC > 1 + INFy monocytes > 1
...
### Overlap with significant microglia LPS genes FDR 5% log FC > 1 + monocytes < -1
...
# Overlap with significant microglia IFNy genes FDR 5% log FC > 1 + LPS monocytes < -1
...
### Overlap with significant microglia LPS genes FDR 5% log FC > 1 + LPS monocytes < -1 
...
### Overlap with significant microglia IFNy genes FDR 5% log FC > 1 + IFNy monocytes < -1 
...
# Overlap with significant microglia LPS genes FDR 5% log FC < - 1 + IFNy monocytes > 1 
